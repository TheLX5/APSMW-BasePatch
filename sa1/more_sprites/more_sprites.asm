...
org $00A1A8
JSL SPRITE_IRAM_RESET
NOP

; Hack main sprite routine.
org $0180A9
JSL SPRITE_MAIN_HACK
NOP
NOP

; Sprite loading routine.
org $02A93C
;JSL SPRITE_LOAD_HACK
JML SPRITE_LOAD_HACK

org $01ABCC
JSL SubSprXPosNoGrvty
RTS
...
org $028922
JSL BLOCK_SPRITE_SPAWN_HACK
NOP

org $02887D
JML BLOCK_SPRITE_SPAWN_WRAPPER

; Sprite/sprite interaction needs fixing
;useless with blue koopa fix
;org $01A43D
;JSL SPR_SPR_INTERACT_SET

;included in blue koopa fix
;org $01A4B6
;JML SPR_SPR_INTERACT_RESTORE
...
org $01A413
	JML SPR_SPR_INTERACT_INIT
	
org $01A4B0
	JML SPR_SPR_INTERACT_LOOP
	
org $01A7C2
	JML SPR_SPR_INTERACT_3
	
org $01A5D3
	JML SPR_SPR_INTERACT_4
	
org $01A5DA
	JML SPR_SPR_INTERACT_5
