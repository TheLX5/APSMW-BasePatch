...
ORG $8A53					; Hijack ClearStack.
	JSL ClearStack				; to make clear new RAM area.
	RTS					;

	NOP #4					; $008A58 - Unused now.
	JML mmc_rom_reset			; $008A5C - Reset Bank Allocation
...
Reset:						; \ Use the "unused" space
	JML SA1_Reset				;  | to store some vectors.
						;  |
IRQ:						;  |
	JML SA1_IRQ				;  |
						;  |
...
ORG $816A					; \ Hijack NMIStart for Dynamic Sprites and 
	JML snes_nmi				; / Character Conversion DMA Table
